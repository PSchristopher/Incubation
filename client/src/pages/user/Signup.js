            ...
            <main className='flex flex-col items-center justify-center w-full flex-1 px-20 text-center'>
                <div className='bg-white rounded-2xl shadow-2xl flex flex-row w-2/3 max-w-4xl'>
                    ...
                    <div className='w-2/5 bg-sky-900 text-white rounded-l-2xl py-36 px-12'>
                        ...
                        <a href='/login' className='border-2 border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-sky-900'>Sign In</a>
                    </div>
                            ...
                            <form>
                                <div className='flex flex-col items-center'>
                                    <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'><FaRegEnvelope className='text-gray-400 m-3' />
                                        <input type="name" name='name' placeholder='Username' className=' bg-gray-100 flex-1' />
                                    </div>
                                </div>
                                <div className='flex flex-col items-center'>
                                    <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'><FaRegEnvelope className='text-gray-400 m-3' />
                                ...
                                <div className='flex flex-col items-center'>
                                    <div className='bg-gray-100 w-64 p-2 flex items-center mb-3'><FaRegEnvelope className='text-gray-400 m-3' />
                                        <input type="number" name='phone' placeholder='Mobile' className=' bg-gray-100 flex-1' />
                                    </div>
                                </div>
                                <div className='flex flex-col items-center'>
                                    ...
                                    <a href='' className='border-2 border-sky-900 rounded-full px-12 py-2 inline-block font-semibold hover:bg-sky-900 hover:text-white'>Sign Up</a>
                                </div>
                            </form>
                        </div>
                    </div>
