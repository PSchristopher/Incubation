                                        ...
                                        ApplicationList.map((obj, index) => {
                                            return (
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap"><button className="text-sky-500 hover:text-sky-700 pl-10 pr-10" > APPROVE </button> </td>
                                                    <td className="px-6 py-4 text-sm font-medium text-right whitespace-nowrap"><button className="text-red-500 hover:text-red-700"  > REJECT </button> </td>
